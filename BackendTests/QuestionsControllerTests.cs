...
namespace BackendTests
{
    public class QuestionsControllerTests
    {
        ...
        public async void GetQuestions_WhenHaveSearchParameter_ReturnsCorrectQuestions()
        {
            ...
            mockDataRepository.Verify(mock => mock.GetQuestionsBySearchWithPaging(
                "Test", 1, 20), Times.Once());
        }
        ...
        public async void GetQuestion_WhenQuestionNotFound_Returns404()
        {
            ...
            var actionResult = Assert
                .IsType<ActionResult<QuestionGetSingleResponse>>(result);
        ...
        public async void GetQuestion_WhenQuestionIsFound_ReturnsQuestion()
        {
            ...
            var actionResult = Assert
                .IsType<ActionResult<QuestionGetSingleResponse>>(result);
            var questionResult = Assert
                .IsType<QuestionGetSingleResponse>(actionResult.Value);
